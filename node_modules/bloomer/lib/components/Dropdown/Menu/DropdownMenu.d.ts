...
export declare function DropdownMenu({ ...props }: DropdownMenu<HTMLElement>): React.DetailedReactHTMLElement<{
    ...
    cellPadding?: React.Key;
    cellSpacing?: React.Key;
    charSet?: string;
    challenge?: string;
    checked?: boolean;
    cite?: string;
